...
# %% [markdown]
# # TabPFN Ablation Study - 3-Group Combinations
#
# Runs all triple patient-group experiments. Each is run with Drug_PC, Drug_Embed, and Drug_PC+Drug_Embed.
...
# %%
with open("../Results/tabpfn/ablation/ablation_results_3group.pkl", "wb") as f:
    pickle.dump(ablation_results, f)
print(f"Saved {len(ablation_results)} results to ablation_results_3group.pkl")
