...
\begin{figure}[!ht]
    ...
    \hfill
    \subcaptionbox{Resistant: sample 2 (pred\,$=269.9$)\label{fig:wfall_r2}}{%
        \includegraphics[width=0.47\textwidth]{figures/shap_v4_single_sample_idx8946.pdf}}\\[6pt]
    ...
    \hfill
    \subcaptionbox{Sensitive: sample \#12778 (true AUC\,$=133.8$, pred\,$=133.7$)\label{fig:wfall_s2}}{%
