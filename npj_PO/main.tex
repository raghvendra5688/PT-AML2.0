...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{External Validation on LeeAML and FIMM-AML}\label{sec3.4}
...
The cross-platform setting i.e. predicting AUC-scale values that are compared against DSS measurements was inherently more challenging than the LeeAML evaluation, given the systematic differences in drug response quantification methodology between FIMM and BeatAML. Despite this, the model demonstrates meaningful rank correlations between predicted and observed drug sensitivity values across FIMM-AML patients as depicted in Figure~\ref{fig:external}B, validating that the transcriptomic and genomic signals captured by PREDICT-AML are informative across distinct clinical institutions and drug sensitivity platforms. 

\textcolor{red}{Raghvendra reached here}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
